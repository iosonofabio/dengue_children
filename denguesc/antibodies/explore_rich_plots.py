...
if __name__ == '__main__':
    ...
    if True:
        plt.ioff()
        pname_clones = clone_sizes.sort_values(by='clone_size').index[-10:]
        for pname, clone_id in pname_clones:
            ...
            fig = d['fig']
            fig.savefig(f'../../figures/antibodies/composite_plots/{pname}_{clone_id}.png')
            plt.close(fig)
